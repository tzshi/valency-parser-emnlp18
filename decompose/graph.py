...
class Word:
    ...
    def __init__(self, word, upos, lemma=None, xpos=None, feats=None, deps=None, misc=None, part=None, layers=None):
        self.word = word
        ...
        self.part = part if part else "_"
        self.layers = layers if layers else ["_", "_", "_", "_"]

    def cleaned(self):
        return Word(self.word, "_")

    def clone(self):
        return Word(self.word, self.upos, self.lemma, self.xpos, self.feats, self.deps, self.misc, self.part, self.cases, self.layers)
